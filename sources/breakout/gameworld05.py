...
class World(tk.Frame):
    ...
    def __init__(self, master):
        ...
        self.canvas.bind("<Left>", lambda _: self.paddle.move(-40))
        self.canvas.bind("<Right>", lambda _: self.paddle.move(40))
    ...
    def draw_text(self, x, y, text, size = "40"):
        font = ("Helvetica", size)
        return self.canvas.create_text(x, y, text = text, font = font, fill = "#ffffff")
